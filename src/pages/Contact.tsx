...
const Contact: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    emailjs
      .send(
        'service_ipxj3e5',     // Replace with your EmailJS Service ID
        'template_rueg6cs',    // Replace with your EmailJS Template ID
        {
        ...
        'OkMF0j-Lz1hPHr4Ot'      // Replace with your EmailJS Public Key
      )
      .then(() => {
                    ...
                    <form onSubmit={handleSubmit}>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div>
                          ...
                          <input
                            ...
                            required
                            className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200 transition text-black"
                      ...
                      <div className="mb-6">
                        ...
                        <textarea
                          ...
                          required
                          rows={6}
                          className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200 transition resize-none text-black"
      ...
      <section className="py-16 mt-8 px-4">
        <div className="container mx-auto">
          <div className="max-w-6xl mx-auto">
            ...
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d494914.6764933452!2d120.48971178842316!3d14.281139316213892!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3397d4eae8163c71%3A0xf0c4d0843bdde727!2sCavite!5e0!3m2!1sen!2sph!4v1746325158143!5m2!1sen!2sph"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen

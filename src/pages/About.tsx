            ...
            <div className="mt-12 bg-white p-8 rounded-lg shadow-md">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="text-center p-4 border border-gray-200 rounded-lg hover:border-blue-500 hover:bg-blue-50 transition-colors">
                  ...
                  <p className="font-medium text-gray-700 hover:text-blue-600 transition-colors">UI/UX Design</p>
              </div>
              ...
              <div className="text-center p-4 border border-gray-200 rounded-lg hover:border-blue-500 hover:bg-blue-50 transition-colors">
                ...
                <p className="font-medium text-gray-700 hover:text-blue-600 transition-colors">Responsive Design</p>
              </div>
              ...
              <div className="text-center p-4 border border-gray-200 rounded-lg hover:border-blue-500 hover:bg-blue-50 transition-colors">
                ...
                <p className="font-medium text-gray-700 hover:text-blue-600 transition-colors">Database Design</p>
              </div>
              ...
              <div className="text-center p-4 border border-gray-200 rounded-lg hover:border-blue-500 hover:bg-blue-50 transition-colors">
                ...
                <p className="font-medium text-gray-700 hover:text-blue-600 transition-colors">Performance Optimization</p>
              </div>
            </div>
              ...
              <div>
                ...
                <div className="space-y-8">
                  <div className="relative pl-8 border-l-2 border-blue-200 pb-8">
                    <div className="absolute -left-2.5 top-0 w-5 h-5 rounded-full bg-blue-600"></div>
                    <div>
                      <span className="text-sm font-medium text-blue-600 mb-1 block">2013 - 2017</span>
                      <h4 className="text-lg font-bold mb-1">B.Sc. in Computer Science</h4>
                  ...
                  <div className="relative pl-8 border-l-2 border-blue-200">
                    <div className="absolute -left-2.5 top-0 w-5 h-5 rounded-full bg-blue-600"></div>
                    <div>
                      <span className="text-sm font-medium text-blue-600 mb-1 block">2017 - 2018</span>
